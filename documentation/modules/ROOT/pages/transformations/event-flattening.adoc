...
transforms.unwrap.schema.change.record.add.headers.enabled=true
transforms.unwrap.delete.handling.mode=rewrite
----
...
[id="extract-new-record-state-schema-change-record-add-headers-enabled"]
|xref:extract-new-record-state-schema-change-record-add-headers-enabled[`schema.change.record.add.headers.enabled`]
|`false`
|Support schema change record adding headers.
